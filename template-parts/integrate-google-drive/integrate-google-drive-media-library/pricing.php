<section class="integrate-google-drive-media-library-addon-pricing media-library-pricing" id="addon-pricing">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 m-auto">
                <div class="plan-head text-center">
                    <div class="imgs">
                        <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/google-drive/media-library-addon/line.png" alt="log-blue">
                    </div>
        ...
        <div class="pricing-wrap">
            <div class="pricing-box annual">
                ...
                <div class="pricing-header text-center">
                    <div class="imgs">
                        <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/google-drive/media-library-addon/line.png" alt="image-1">
                    </div>
                    <h3>Monthly</h3>
                    <p>BILLED Monthly</p>
                </div>
