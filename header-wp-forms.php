                ...
                <div class="row">
                    <nav class="navbar navbar-expand-xl primary-nav <?php echo esc_attr($navbar_scheme);
                        ...
                        <div class="navbar-navs">
                            ...
                            <a class="navbar-brand brand-wp-froms" href="/wp-froms" title="WP Froms" rel="home">
                                <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/wp-froms/wp-froms-logo.png" alt="WP Froms">
                            </a>
                        </div>
                        ...
                        <div id="navbar" class=" mobile-menu collapse navbar-collapse">
                            <?php if (wp_is_mobile()) { ?>
                                <span class="mobile-close-btn d-flex justify-content-between align-items-center">
                                    <a class="navbar-brand brand-wp-froms logo-btn" href="/wp-froms" title="WP Froms" rel="home">
                                        <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/wp-froms/wp-froms-logo.png" alt="WP Froms">
                                    </a>
                            ...
                            wp_nav_menu(
                                array(
                                    'theme_location' => 'wp-froms-menu',
                                    'container'      => '',
                                    'menu_class'     => 'navbar-nav ms-auto wp-froms-nav',
                            ...
                            <div class="buy-now-btn buy-now-btn-wp-froms">
