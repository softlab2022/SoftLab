                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="wp-radio-content m-auto">
                            ...
                            <div class="wp-radio-head">
                                <h1><span>Worldwide</span> Online Radio Stations Directory for WordPress</h1>
                                <p>WP Radio is a worldwide online radio stations directory plugin for WordPress. You can easily create a full-featured online radio directory website</p>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="radio-player-content m-auto">
                            ...
                            <div class="radio-player-head">
                                <h1><span>Live</span> Shoutcast, Icecast and Audio Stream Player for WordPress</h1>
                                <p>WP Radio is a worldwide online radio stations directory plugin for WordPress. You can easily create a full-featured online radio directory website</p>
                            </div>
                        </div>
                        <div class="row">
