                ...
                <div class="row">
                    <nav class="navbar navbar-expand-xl primary-nav <?php echo esc_attr($navbar_scheme);
                        ...
                        <div class="navbar-navs">
                            ...
                            <a class="navbar-brand brand-connect-dropbox" href="/connect-dropbox" title="connect Dropbox" rel="home">
                                <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/connect-dropbox/logo.png" alt="Integrate Dropbox">
                            </a>
                        </div>
                        ...
                        <div id="navbar" class="mobile-menu collapse navbar-collapse">
                            ...
                            wp_nav_menu(
                                array(
                                    'theme_location' => 'connect-dropbox-menu',
                                    'container'      => '',
                                    'menu_class'     => 'navbar-nav ms-auto connect-dropbox-nav',
                            ...
                            <div class="buy-now-btn buy-now-btn-connect-dropbox">
                                <a href="/connect-dropbox-pricing"><i class="fa-solid fa-cart-shopping"></i> Buy Now</a>
                            </div>
