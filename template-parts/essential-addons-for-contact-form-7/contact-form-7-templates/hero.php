                ...
                <div class="contact-form-7-templates-content text-center">
                    ...
                    <div class="contact-form-7-templates-search-wrap">
                        <form id="contact-form-7-templates-search-form" class="contact-form-7-templates-search-form">
                            ...
                            <button class="contact-form-7-templates-btn contact-form-7-templates-search-submit">
    ...
    (function($) {
        const app = {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('.contact-form-7-templates-search-results').html(response.data);
                        } else {
                            $('.contact-form-7-templates-search-results').html('<div class="softdocs-search-item"><h3>No results found</h3></div>');
                        }
                    },
                    complete: function() {
            ...
            handleSearchClose: function() {
                ...
                $('.contact-form-7-templates-search-results').html('');
                                    ...
                                    <div class="main-item">
                                        ...
                                        <div class="item-button">
                                            <div class="buttons-group">
                                                <!-- <a href="#" class="button"><i class="fa-solid fa-circle-plus"></i> Use Template</a> -->
                                                <?php
                                                // Check if the current post is of the custom post type 'form'
                                                if (is_singular('form')) {
                                                    $meta_value = get_post_meta(get_the_ID(), 'slfm_meta_field_url', true);

                                                    if (!empty($meta_value)) {
                                                        echo '<a href="' . esc_url($meta_value) . '" class="button1"><i class="fa-solid fa-eye"></i> View Demo</a>';
                                                    } else {
                                                        echo '<a href="#" class="button1"><i class="fa-solid fa-eye"></i> View Demo</a>';
                                                    }
                                                } else {
                                                    echo '<a href="#" class="button1"><i class="fa-solid fa-eye"></i> View Demo</a>';
                                                }
        ...
        categoryTitle.addEventListener('click', function(e) {
            ...
            .then(data => {
                ...
                if (categoryTitleElement) {
                    categoryTitleElement.textContent = this.textContent.trim();
                }
            })
...
<!-- <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Automatically trigger the first category click on page load
        const firstCategoryTitle = document.querySelector('.category-title.active');
        if (firstCategoryTitle) {
            firstCategoryTitle.click();
        }
        ...
        categoryTitles.forEach(categoryTitle => {
            categoryTitle.addEventListener('click', function(e) {
                ...
                // Add active class to the clicked category title
                this.classList.add('active');
        ...
        docListItems.forEach(item => {
            item.addEventListener('click', function(e) {
                ...
                // Remove active class from all document list items
                docListItems.forEach(item => item.classList.remove('active'));

                // Add active class to the clicked document list item
                this.classList.add('active');
