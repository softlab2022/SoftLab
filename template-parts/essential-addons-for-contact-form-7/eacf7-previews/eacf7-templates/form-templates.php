<section id="fields-custom-description-area">
    <div class="container">
        <div class="row">
            <div class="col-lg-9 m-auto">
                <div class="template-feilds-hero-content hero-content-description text-center">
                    <p>
                    <?php
                    $description = get_post_meta(get_the_ID(), 'softlab_custom_description', true);
                        ...
                        <div class="form-area" data-index="0">
                            <div class="form-button-area-title">
                                ...
                                <div class="form-button-area">
                                    ...
                                    <button class="templates-show-buttons" data-index="0">
                                        <i class="fa-solid fa-code"></i> Show Code
                                    </button>
                                    <button class="templates-copy-buttons" data-index="0" style="display: none;">
                                        <i class="fa-solid fa-copy"></i> Copy
                                    </button>
                                </div>
                            </div>
                            <div class="form-button-area-item">
                                <div class="templates-eacf7-form" data-index="0">
                                    <?php
                                ...
                                <div class="templates-form-code" data-index="0" style="display:none;">
                                    <?php
                                    if (!empty($sl_meta_field['shortcode'])) {
