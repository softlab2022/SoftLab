...
<section id="features" class="integrate-dropbox-features">
    <div class="container">
            ...
            <div class="row feature-item align-items-center feature-<?php echo $key; ?> <?php echo ! $is_odd ? 'flex-row-reverse' : '' ?>">
                ...
                <div class="<?php echo $image_class; ?>">
                    <div class="feature-item-img">
                        <img class="img-fluid"
                             src="<?php echo get_template_directory_uri(); ?>/assets/images/integrate-dropbox/features/<?php echo $key; ?>-illustration.png"
                    ...
                    <div class="feature-item-content text-center text-md-start">
						...
						<?php if ( ! $is_integration ) { ?>
                            <img class="img-fluid feature-icon"
                                 src="<?php echo get_template_directory_uri(); ?>/assets/images/integrate-dropbox/features/<?php echo $key; ?>-icon.png"
                                 alt="<?php echo $feature['title']; ?>">
						<?php } ?>
						...
						<?php if ( ! $is_integration && ! in_array( $key, [
                            ...
                            <a href="/integrate-dropbox-<?php echo $key; ?>" class="feature-demo-btn">View demo</a>
						<?php } ?>
        ...
        <div class="row">
            <div class="col-lg-7 m-auto">
                <div class="feature-head text-center">
                    ...
                    <div class="vector4">
                        <img class="img-fluid"
                             src="<?php echo get_template_directory_uri(); ?>/assets/images/integrate-dropbox/ex-feature/ellipse-2.png"
                             alt="ellipse-2">
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-9 m-auto">
                <div class="woocommerce-img text-center">
                    <img class="img-fluid"
                         src="<?php echo get_template_directory_uri(); ?>/assets/images/integrate-dropbox/support-img.png"
                         alt="support-img">
                </div>
            </div>
        </div>
