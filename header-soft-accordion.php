                ...
                <div class="row">
                    <nav class="navbar navbar-expand-md primary-nav <?php echo esc_attr($navbar_scheme);
                        ...
                        <div class="navbar-navs">
                            ...
                            <a class="navbar-brand brand-soft-accordion" href="/soft-accordion/" title="Soft Accordion" rel="home">
                                <img class="img-fluid logo-black" src="<?php echo get_template_directory_uri(); ?>/assets/images/soft-accordion/soft-accordion-logo.png" alt="Soft Accordion">
                                <img class="img-fluid logo-white" src="<?php echo get_template_directory_uri(); ?>/assets/images/soft-accordion/soft-accordion-logo-withe.png" alt="Soft Accordion">
                            </a>
                        </div>
                        ...
                        <div id="navbar" class=" mobile-menu collapse navbar-collapse">
                            ...
                            wp_nav_menu(
                                array(
                                    'theme_location' => 'soft-accordion-menu',
                                    'container'      => '',
                                    'menu_class'     => 'navbar-nav ms-auto soft-accordion-nav',
                            ...
                            <div class="buy-now-btn buy-now-btn-soft-accordion">
                            <a href="/soft-accordion-pricing/"><i class="fa-solid fa-cart-shopping"></i> Buy Now</a>
                            </div>
