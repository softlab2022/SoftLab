        ...
        while ( $query->have_posts() ) : $query->the_post();
            ...
            <div class="col-lg-4 col-md-6">
                <div class="main-item">
                    <div class="item-img">
                        <img class="img-fluid"
                             src="<?php echo get_the_post_thumbnail_url( $post_id ) ?: 'https://via.placeholder.com/150'; ?>"
                             alt="<?php the_title_attribute(); ?>">
                        <div class="item-button">
                            <div class="buttons-group">
                                <a href="<?php echo get_permalink( $post_id ); ?>" class="button1" target="_blank"><i
                                            class="fa-solid fa-eye"></i> View Demo</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="main-item">
                    <div class="item-img">
                        ...
                        <div class="item-button">
                            <div class="buttons-group">
                                <a href="<?php echo $permalink; ?>" class="button1" target="_blank"><i
                                            class="fa-solid fa-eye"></i> View Demo</a>
                            </div>
                        </div>
                    </div>
