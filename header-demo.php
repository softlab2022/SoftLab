  ...
  <!-- Sticky Notification -->
    ...
    <div id="wrapper">
        ...
        <header class="site-header">
            <div class="container">
                <div class="row">
                    <nav class="navbar navbar-demo navbar-expand-xl primary-nav <?php echo esc_attr($navbar_scheme);
                        ...
                        <div id="navbar" class="mobile-menu collapse navbar-collapse">
                            <?php if (wp_is_mobile()) { ?>
                                <span class="mobile-close-btn d-flex justify-content-between align-items-center">
                                    <a class="navbar-brand brand-demo logo-btn" href="/" title="Demo" rel="home">
                                        <span><?php echo esc_html__('Softlab Demo Portal', 'softlab'); ?></span>
                                    </a>
