...
$features = [
	[
		...
		'image'       => get_template_directory_uri() ."/assets/images/connect-dropbox/uploader-demo/one-click.png",
	...
	[
		...
		'description' => 'You and also your users can upload files directly to your Google Drive account from your site.',
		'image'       => get_template_directory_uri() ."/assets/images/connect-dropbox/uploader-demo/uploader-style.png",
	...
	[
		...
		'description' => 'connect your favorite services and add advanced features with official Forms. Each license offers a range of add-ons included with your annual subscription.',
		'image'       => get_template_directory_uri() ."/assets/images/connect-dropbox/uploader-demo/form-contact.png",
