...
$features = [
    ...
    'dark-mode-usage-analytics' => [
        'title'       => 'Dark Mode Usage Analytics',
            ...
            <div class="row feature-items dark-mode align-items-center <?php echo $key; ?> <?php echo ! $is_odd ? 'flex-row-reverse' : '' ?>">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="feature-content">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/dracula/home/feature/<?php echo $key; ?>-icon.png" alt="" class="img-fluid">
