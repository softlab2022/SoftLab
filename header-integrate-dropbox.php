        ...
        <div class="container">
            <div class="row">
                ...
                if ( is_home() || is_front_page() ) : echo ' home'; endif; ?>">
                    ...
                    <a class="navbar-brand brand-integrate-dropbox" href="/integrate-dropbox"
                       title="Integrate Dropbox" rel="home">
                        <img class="img-fluid"
                             src="<?php echo get_template_directory_uri(); ?>/assets/images/integrate-dropbox/logo.png"
                             alt="Integrate Dropbox">
                    </a>
                    ...
                    <div id="navbar" class="collapse navbar-collapse">
						...
						wp_nav_menu(
							array(
								'theme_location' => 'integrate-dropbox-menu',
								'container'      => '',
								'menu_class'     => 'navbar-nav ms-auto integrate-dropbox-nav',
                        ...
                        <div class="buy-now-btn buy-now-btn-integrate-dropbox">
                            <a href="/integrate-dropbox-pricing"><i class="fa-solid fa-cart-shopping"></i> Buy Now</a>
                        </div>
