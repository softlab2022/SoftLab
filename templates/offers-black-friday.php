...
<section class="black-friday-offers" id="black-friday-offers">
    <div class="container">
...
<script>
    ...
    (function($) {
        $(document).on('ready', function() {
            ...
            //Handle Integrate Google Drive
            $('.offer-buy-now-btn-igd').on('click', function(e) {
                e.preventDefault();
            ...
            //Handle Radio Player
            $('.offer-buy-now-btn-rp').on('click', function(e) {
                e.preventDefault();
            ...
            //Handle Dracula Dark Mode
            $('.offer-buy-now-btn-dm').on('click', function(e) {
                e.preventDefault();
