...
$features = [
	[
		...
		'image'       => get_template_directory_uri() ."/assets/images/integrate-dropbox/uploader-demo/one-click.png",
	...
	[
		...
		'description' => 'You and also your users can upload files directly to your Google Drive account from your site.',
		'image'       => get_template_directory_uri() ."/assets/images/integrate-dropbox/uploader-demo/uploader-style.png",
	...
	[
		...
		'image'       => get_template_directory_uri() ."/assets/images/integrate-dropbox/uploader-demo/form-contact.png",
