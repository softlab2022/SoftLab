...
class SoftLa
{
	...
	function enqueue_scripts()
	{
		...
		//popup img Scripts
		if (is_single()) {
			wp_enqueue_style('magnific-popup', get_theme_file_uri('assets/vendor/magnific-popup.css'), array(), $theme_version);

			wp_enqueue_script('jquery-magnific-popup', get_theme_file_uri('assets/vendor/jquery.magnific-popup.min.js'), array(), '1.1.0', true);
		}
