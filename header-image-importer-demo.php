            ...
            <div class="row">
				...
				if ( is_home() || is_front_page() ) : echo ' home'; endif; ?>">
                    ...
                    <a class="navbar-brand" href="<?php echo esc_url( home_url() ); ?>"
                       title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
                       <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/wp-radio/import-logo.png" alt="import-logo">
                    </a>
                    ...
                    <div id="navbar" class="collapse navbar-collapse">
                        ...
                        <div class="buy-now">
                        <a href="#"><i class="fa-solid fa-cart-shopping"></i> Get Started</a>
                        </div>
