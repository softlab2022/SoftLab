        ...
        <div class="row align-items-center">
            <div class="col-lg-7 m-auto">
                <div class="hero-content text-center">
                    <h1>Grow Your WordPress Site the Way You Want with a Better Range of Solutions</h1>
                    <p>
                        Clean, Simple & Affordable Premium WordPress Plugins for You to Become the Next Big Thing in Your Website.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="integrate-google-drive-content m-auto">
                            ...
                            <div class="integrate-google-drive-head">
                                <h1>Complete <span>Google Drive</span> Cloud Solution For WordPress</h1>
                                <p>Integrate Google Drive – is the best and easy-to-use Google Drive cloud solution plugin for WordPress to integrate your Google Drive documents and media directly into your WordPress Website.</p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <a href="#" class="btn drive-butt btn-primary">Explore more features <i class="fa-solid fa-arrow-right"></i></a>
                    </div>
