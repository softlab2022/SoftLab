...
$features = [
	[
		...
		'image'       => get_template_directory_uri() ."/assets/images/connect-dropbox/photo-demo/optimized.png",
	...
	[
		...
		'image'       => get_template_directory_uri() ."/assets/images/connect-dropbox/photo-demo/masonry-grid.png",
	...
	[
		...
		'description' => 'You see something which looks visually like a masonry layout for our google drive cloud.',
		'image'       => get_template_directory_uri() ."/assets/images/connect-dropbox/photo-demo/lightbox.png",
