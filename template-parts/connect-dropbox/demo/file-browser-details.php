...
$features = [
	[
		...
		'image'       => get_template_directory_uri() . "/assets/images/connect-dropbox/file-bowser-demo/documents.png",
	...
	[
		...
		'image'       => get_template_directory_uri() . "/assets/images/connect-dropbox/file-bowser-demo/multiple.png",
		'features'    => [
	...
	[
		...
		'image'       => get_template_directory_uri() . "/assets/images/connect-dropbox/file-bowser-demo/appearance.png",
