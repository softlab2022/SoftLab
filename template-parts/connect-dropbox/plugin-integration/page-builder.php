<?php
    ...
    $features = [
        'classic-editor' => [
            ...
            'description' => 'The Connect Dropbox WordPress plugin is compatible with the Classic Editor page builder, allowing users to easily and conveniently manage and insert Dropbox files into their posts and pages without leaving the editor.',
        ...
        'elementor' => [
            ...
            'description' => 'With the added compatibility for the Elementor website builder, users can easily incorporate Dropbox files and folders into their Elementor-designed pages and posts. This integration offers a convenient way to share and display content from Dropbox directly on your website.',
        ...
        'divi' => [
            ...
            'description' => 'Add Dropbox modules, embed documents, and insert file view links and download links using the Dropbox Gutenberg editor blocks.',
        ...
        <div class="row vector-area">
            <div class="col-lg-7 m-auto">
                <div class="section-head text-center">
                    ...
                    <p class="heading-description">Connect Dropbox is designed to work seamlessly with widely used page builders like Classic Editor, Gutenberg, Elementor, Divi, and others.</p>
                </div>
            </div>
