...
$features = [
	...
	'file-uploader' => [
		'title'       => 'File Uploader',
		'description' => 'connect Google Drive features a user-friendly file uploader to upload files into the Google Drive cloud platform from your website. Users can see an upload progress bar, file name, cancel uploading action, and media preview for improved interactions.',
	],
	...
	'page-builder' => [
		...
		'description' => 'We provide a wide & popular page builder supports all over the world. That means connect Google Drive is 100% compatible with the most popular page builders. So you are up to go with whatever page builders are you using.',
	],

	'form' => [
		'title'       => 'Popular Forms Connect & Easy to Use',
		'description' => 'connect your favorite services and add advanced features with the official Form plugin integration feature. It’s time to build a powerful module for popular forms by using connect Google Drive plugin.',
	],
...
<section id="features" class="connect-dropbox-features">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="section-head text-center">
                    ...
                    <p>We provide the best and most productive integrations for Google Drive. You are near to discovering some coolest features of connect Google Drive & easiest way to connect with us. Join the party now!</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-7 m-auto">
                <div class="feature-head text-center">
                    ...
                    <p>You can connect your Google Drive files nicely into WooCommerce, and it allows you to serve
