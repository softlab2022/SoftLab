...
$features = [
    'contact-form' => [
        ...
        'description' => 'Allows you to upload your files directly to Dropbox from your Contact Form 7 upload field.',
    ...
    'ninja-form' => [
        'title'       => 'Ninja Forms',
        'description' => 'Allows you to upload your files directly to Dropbox from your Ninja Forms upload field.',
    ...
    'wp-form' => [
        'title'       => 'WPForms',
        'description' => 'Allows you to upload your files directly to Dropbox from your WPForms upload field..',
    ...
    'gravity-form' => [
        'title'       => 'Gravity Forms',
        'description' => 'Allows you to upload your files directly to Dropbox from your Gravity Forms upload field.',
    ...
    'fluent-form' => [
        'title'       => 'Fluent Forms',
        'description' => 'Allows you to upload your files directly to Dropbox from your Fluent Forms upload field.',
        ...
        <div class="row vector-area">
            <div class="col-lg-7 m-auto">
                <div class="section-head  text-center">
                    ...
                    <p class="heading-description">Do you want more flexibility with the popular form plugins? The Connect Dropbox plugin is compatible with Contact Form 7, WPForms, Gravity Forms, Ninja Forms, Fluent Forms, and Formidable Forms to create stunning upload fields.</p>
                </div>
            </div>
