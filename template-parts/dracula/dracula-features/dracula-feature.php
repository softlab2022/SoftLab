        ...
        <div class="row dark-mode align-items-center">
            ...
            <div class="col-lg-6">
                <div class="feature-content">
                    ...
                    <p>Quickly change the dark mode color from the predefined ready-made color schema and make your website look standout for the user! wp dark mode.</p>
        ...
        <div class="row dark-mode color-adjustments align-items-center">             
            <div class="col-lg-6">
                <div class="feature-content">
                    ...
                    <p>Collection of toggle buttons / on-off switches which can be practically used in a website. Designed using just one click without any coding.</p>
                    <a href="#" class="view-demo">check demo</a>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row dark-mode align-items-center">  
            ...
            <div class="col-lg-6">
                <div class="feature-content">
                    ...
                    <p>You can change the toggle button style from the plugin's settings page. By default, the dark mode toggle button will be displayed in the bottom right corner of the site. You can change the position and size of the toggle button in the plugin's settings</p>
                    <a href="#" class="view-demo">check demo</a>
                </div>
            </div>
        </div>
         ...
         <div class="row dark-mode color-adjustments align-items-center">             
            <div class="col-lg-6">
                <div class="feature-content">
                    ...
                    <p>This plugin adds the Dark Mode option that you can turn on and off. Locate the Dark Mode option.</p>
                    <a href="#" class="view-demo">check demo</a>
                </div>
            </div>
            <div class="col-lg-6">
