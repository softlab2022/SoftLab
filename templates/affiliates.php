        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="hero-image">
                    <!-- <img src="images/hero-image.svg" s alt="Hero image"> -->
                    <img src="https://wppool.dev/wp-content/themes/wppool/assets/img/affilieat-images/hero-image.svg" alt="hero image">
                </div>
            </div>
        </div>
    </div>
...
<!--reviews section-->
<div class="reviws-section faq" style="background: url('https://wppool.dev/wp-content/themes/wppool/assets/img/affilieat-images/colored__bg.png');">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-title">
        ...
        <!-- <div class="owl-carousel owl-theme">
            <div class="item">
                <div class="single-item">
                    ...
                    <p>You’ll not face any issue about payment while promoting. You’ll  get  your amount on the
                        15th date every month.
                    </p>
                 <div class="mun" style="background: url('./images/dots.svg');">01</div>
                </div>
            </div> -->
        ...
        <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="cta-img">
                        ...
                        <img src="https://wppool.dev/wp-content/themes/wppool/assets/img/affilieat-images/breifcase.svg" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
