<section id="ecommerce-plugins">
    <div class="container">
        ...
        <div class="row vector-area">
            <div class="col-lg-7 m-auto">
                <div class="section-head text-center">
                    ...
                    <p class="heading-description">Do you want more freedom with popular E-commerce plugin integration with your own Dropbox Account? Connect Dropbox plugin does the same for you!</p>
                </div>
            </div>
        ...
        <!----===== Woocommerce, Dokan, Easy Digital Downloads area =====------>
        ...
        <div id="woocommerce" class="row feat-shadw">
            ...
            <div class="col-lg-6 col-md-6 m-auto">
                <div class="wooco-feature-area text-center">
                    ...
                    <p class="feature-description">You can sell your Dropbox files as downloadable products by integrating this plugin with the WooCommerce or Easy Digital Downloads plugin.</p>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 m-auto">
                <div class="wooco-feature-area text-center">
                    ...
                    <p class="feature-description">You can allow customers to upload files in WooCommerce and store them in a specific Dropbox folder. This feature is useful for customers who want something in terms of their custom test.</p>
                </div>
            </div>
        ...
        <div id="dokan" class="row feat-shadw">
            ...
            <div class="col-lg-6 col-md-6 m-auto">
                <div class="wooco-feature-area text-center">
                    ...
                    <p class="feature-description">You can allow your vendors to serve their downloadable product files directly from Dropbox, and also, vendors can let their customers upload files for their products to the vendor’s Dropbox account when any customer purchases any products.</p>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 m-auto">
                <div class="wooco-feature-area text-center">
                    ...
                    <p class="feature-description">You can allow vendors in Dokan to enable customer file uploads on WooCommerce and store them in a specific Dropbox folder. This feature can be handy for customers to upload any custom files and store them inside vendors' allocated Dropbox accounts.</p>
                </div>
            </div>
        ...
        <div id="easy-digital" class="row feat-shadw">
            <div class="col-lg-7 m-auto">
                <div class="woocommerce-head vector-area text-center">
                    ...
                    <p class="wooco-description">Allows you to serve your Dropbox files as downloadable files and let customers upload files to Dropbox by using Easy Digital Downloads (EDD) platform.</p>
                </div>
        ...
        <div class="row feat-shadw">
            <div class="col-lg-7 m-auto">
                <div class="woocommerce-head tutor-lms vector-area text-center">
                    ...
                    <p class="wooco-description">The integration of the Connect Dropbox plugin within Tutor LMS presents a powerful solution for instructors seeking a more efficient approach to managing their course materials. With this plugin, instructors can link their Dropbox accounts to Tutor LMS, enabling them to easily access and manage their Dropbox course files within the platform. See how it works!</p>
                </div>
        ...
        <div class="row feat-shadw background-hide">
            <div class="col-lg-7 m-auto">
                <div class="woocommerce-head tutor-lms vector-area text-center">
                    ...
                    <p class="wooco-description">Integrating Dropbox with the WordPress Media Library allows you to use Dropbox files as media attachments directly in WordPress. This integration facilitates easy uploading, importing, and synchronizing of media content between WordPress and Dropbox.</p>
                </div>
