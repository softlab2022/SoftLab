...
/**
 * Template Name: Multimedia Audio Player Skins
 *
 */
        ...
        <div class="row">
            <div class="col-lg-6 m-auto">
                <div class="multiple-head text-center">
                    <h1>Audio Player Skins</h1>
                    <p>Choose from a variety of stylish and responsive audio player skins that match your brand and enhance user engagement.</p>
                </div>
            </div>
        </div>
    </div>
