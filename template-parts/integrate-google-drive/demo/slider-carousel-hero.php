        ...
        <div class="row">
            <div class="col-lg-6 m-auto">
                <div class="slider-carousel-demo-head text-center">
                    ...
                    <p>The Slider Carousel feature in our Google Drive plugin lets you create a slideshow of images or videos from your Google Drive. You can customize it with autoplay and navigation buttons to make your content more engaging and visually appealing.</p>
                </div>
            </div>
        </div>
